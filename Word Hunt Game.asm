...
byte 'w ','a ','y ','l ','h ','u ','z ','a ','p ','d '
byte 'a ','s ','a ','l ','h ','s ','f ','a ','h ','a '
...
M10 byte "Hidden words are FAHAD AAQIB SARIM JATIN FAHEEM",0
...
dic byte "!fahad!aaqib!sarim!jatin!faheem!hytr!",0
.code
;############################ MAIN ###############################
main PROC
